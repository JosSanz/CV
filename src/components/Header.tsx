        ...
        <header className={headerStyles.header}>
            ...
            <address className={headerStyles.info}>
                ...
                <div className={headerStyles['info-item']}>
                    ...
                    <a href='https://www.linkedin.com/in/jsanchezo' target='_blank' referrerPolicy='no-referrer' className={headerStyles['info-item__text']}>www.linkedin.com/in/jsanchezo</a>
                </div>
                <div className={headerStyles['info-item']}>
